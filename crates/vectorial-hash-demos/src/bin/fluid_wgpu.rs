...
// The overlay helpers (quads + the 3x5 font) live in `ui2d` so the second demo that needs a
// HUD does not carry a second copy of the glyph table. Lifted 2026-09-04, unchanged.
use vectorial_hash_demos::ui2d::{push_quad, push_text, UiVertex};
